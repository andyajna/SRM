...
class UpdatesControllerTest < ActionController::TestCase
  ...
  test "should create update" do
    assert_difference('Update.count') do
      post :create, update: { date: @update.date, note: @update.note, staff: @update.staff, student_id: @update.student_id }
    end
  ...
  test "should update update" do
    patch :update, id: @update, update: { date: @update.date, note: @update.note, staff: @update.staff, student_id: @update.student_id }
    assert_redirected_to update_path(assigns(:update))
  end
